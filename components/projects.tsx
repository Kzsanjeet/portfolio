...
const projects = [
  ...
  },
  {
    ...
    technologies: ["Express.js", "MongoDB", "Postman", "GitHub", "TypeScript"],
  ...
  },
  {
    title: "Casemandu",
    description:
      "Casemandu is a leading e-commerce platform based in phone cover business in Nepal.",
    image: "/casemandu.png?height=200&width=300",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind",
    ...
    githubUrl: "https://github.com/Kzsanjeet/CASEMANDU-API",
    liveUrl: "https://casemandu.com.np",
  },
  {
    title: "Vajra Foundation Nepal",
    description:
      "Vajra Foundation Nepal is a non-profit organization dedicated to supporting education and healthcare initiatives in rural Nepal.",
    image: "/vajra.png?height=200&width=300",
    technologies: ["TypeScript", "Node.js", "Postman", "Express.js", "Github"],
    githubUrl: "https://github.com/SBNInnovation/vajraApi",
    liveUrl: "https://vajrafoundation.org",
  },
];
